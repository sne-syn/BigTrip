...
} from './components/edit-event-template'
import {
  createTripEventsListTemplate
} from './components/events-list-template'
import {
  createFilterTemplate
} from './components/filter-template'
import {
  createFirstNewEvent
} from './components/first-event-template'
import {
  createMenuTemplate
} from './components/menu-template'
import {
  createNewEventTemplate
} from './components/new-event-template'
import {
  createSortTemplate
} from './components/sort-template'
import {
  createMainRouteInfoTemplate
} from './components/trip-main-template'
